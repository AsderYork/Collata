/*
  ...
  - Added the required column `uuid` to the `Cardstacks` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Cardstacks" ("authorId", "boardId", "createdAt", "id", "name", "order", "trash") SELECT "authorId", "boardId", "createdAt", "id", "name", "order", "trash" FROM "Cardstacks";
